...
class Header extends Component {
  ...
  loginLogic = () => {
   if (Object.keys(this.props.currentUser).length === 0) {
    return (
      <div>
        {console.log(this.props.currentUser["user_name"])}

    <p><Link to='/login'><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/7c/User_font_awesome.svg/1920px-User_font_awesome.svg.png" alt="login"/>Login</Link></p><br></br><br/>
    <p><Link to='/signup'><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/7c/User_font_awesome.svg/1920px-User_font_awesome.svg.png" alt="signup" />Signup</Link></p>
     ...
     return (
      <div>
            <p><Link to='/inbox'><img src="https://i.imgur.com/jq9YZJU.png" alt="inbox"/>Inbox</Link></p><br></br><br></br>
