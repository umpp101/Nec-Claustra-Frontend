    ...
    return (
        <header className="App-header">
          <Link to='/'><img className="logo" src="https://i.imgur.com/2CXy1QL.png" /></Link>
            ...
            <p onClick={this.props.handleLogout}><Link to='/'><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/7c/User_font_awesome.svg/1920px-User_font_awesome.svg.png"/>Logout</Link></p>
